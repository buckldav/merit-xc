...
function MeetSchedules() {
  return (
    <article>
      ...
      <iframe id="schedule" frameBorder="false" title="meet schedule" src="https://docs.google.com/document/d/1WNexz0tnHv_Q4r3bL5Iuj6Z-XKOsWZHgj43_KWPz-SY/preview">Loading...</iframe>
    </article>
  );
}
